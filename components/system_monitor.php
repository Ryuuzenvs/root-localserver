<div class="mb-5">
    ...
    <div class="card p-4 h-100 <?= $mewah ? 'animate__animated animate__zoomIn' : '' ?>">
        <div class="label-text mb-1 text-info text-uppercase small" style="letter-spacing: 2px;">CPU Load</div>
        ...
        <div class="col-md-4">
            <div class="card p-4 text-center <?= $mewah ? 'animate__animated animate__zoomIn' : '' ?>">
                <div class="label-text mb-1">CPU Temperature</div>
                <div id="cpu_temp" class="stat-value">--°C</div>
            </div>
        </div>

        <div class="col-md-4 <?= $mewah ? 'animate__animated animate__zoomIn' : '' ?>">
            <div class="card p-4">
